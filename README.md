...
| **Media** | Insert image (URL, modal-based), Upload image (file picker, 10 MB limit), Paste image (clipboard), Drag & drop image files (10 MB limit), Insert video/embed via modal (sanitized iframes) |
